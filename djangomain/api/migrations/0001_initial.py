# Generated by Django 3.0.7 on 2020-06-26 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RIC', models.CharField(blank=True, max_length=200)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='stock',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.StockCounter', to_field='name'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
